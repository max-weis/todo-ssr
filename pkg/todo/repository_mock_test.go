...
func (_m *repositoryMock) List(ctx context.Context, page todo.Page) ([]todo.Todo, error) {
	ret := _m.Called(ctx, page)

	var r0 []todo.Todo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, todo.Page) ([]todo.Todo, error)); ok {
		return rf(ctx, page)
	}
	if rf, ok := ret.Get(0).(func(context.Context, todo.Page) []todo.Todo); ok {
		r0 = rf(ctx, page)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, todo.Page) error); ok {
		r1 = rf(ctx, page)
	} else {
		r1 = ret.Error(1)
	}
